...
<form action="edit.php" method="POST">
      ...
      <input type="password" placeholder="Password" name="pwd" value="<?php echo $row['password'] ?>" id="">
      <input type="password" placeholder="Confirm password" name="con_pwd" value="<?php echo $row['password'] ?>" id="">
